...
You can also use the built-in function **prop.test()**.  If you choose to use this function, however, it is vital that you "turn off" the continuity correction by including the parameter *correct = FALSE* inside the function. You will get the **incorrect** answer if you do not do this.
