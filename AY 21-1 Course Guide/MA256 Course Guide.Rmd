...
* Do: Follow the **Lesson 3 Example Code** document on GitHub.
...
* Do: Follow the **Lesson 5 Example Code** document on GitHub.
...
* Do: Follow the **Lesson 6 Example Code** document on GitHub.
...
* Do: Follow the **Lesson 7 Example Code** document on GitHub.
...
* Do: Follow the **Lesson 8 Example Code** document on GitHub.
...
* Do: Follow the **Lesson 9 Example Code** document on GitHub.
...
* Do: Submit your work from **Lesson 9** before the start of class.
* Do: Follow the **Lesson 10 Example Code** document on GitHub.
