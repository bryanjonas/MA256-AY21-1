...
### Objectives:
* Understand sample spaces, random experiments, and the axioms of probability
* Understand union and intersection
* Identify the differences between permutations and combinations

### Before Class Activities:
* Read: *Advanced Statistical Investigations With Probability* - Chapter 2.1 - 2.4
* Do: Complete and submit homework for this lesson available on Teams.

### After Class Activities:
* Review the material for this lesson.
...
### Objectives: 
* Understand condition probably and apply Bayes Theorem
* Identify and utilize random variables
* Understand statistical independence

### Before Class Activities:
* Read: *Advanced Statistical Investigations With Probability* - Chapter 2.5 - 2.9
* Do: Complete and submit homework for this lesson available on Teams.
...
## Lesson 26: Discrete Distributions
* Determine probabilities from probability mass functions and the reverse
* Determine probabilies and probability mass functions from cumulative distribution functions and the reverse
...
* Calculate probabilites and determine means and variances for some commmon discrete probability distributions

### Objectives:

### Before Class Activities:
* Read: *Advanced Statistical Investigations With Probability* - Chapter 3.1 - 3.5
* Wavetops: *Advanced Statistical Investigations With Probability* - Chapter 3.6 - 3.8
* Do: Complete and submit homework for this lesson available on Teams.  
*Wavetops means understand the big concepts but don't be concerned with deeply understanding these section.*
...
* Calculate probabilities, determinemeans and variances for
some common continuous probability distributions

### Before Class Activities:
* Read: *Advanced Statistical Investigations With Probability* - Chapter 5.1 - 5.7
* Do: Complete and submit homework for this lesson available on Teams.
