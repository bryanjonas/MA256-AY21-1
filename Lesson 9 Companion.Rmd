...
Another reason is that interpreting the constant can be fraught with issues: Perhaps $x_{n} = 0$ falls outside your data set for all values of *n*? Perhaps $x_{n} = 0$ has no meaning such as for a weight or height variable? These are just a couple examples of why I don't waste too much time considering the intercept constant. 
